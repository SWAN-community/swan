...
Find out about the [principles](explainer-principles.md) involved in SWAN, the requirments for a possible [legal entity](legal-entity-explainer.md) to govern SWAN, the [model contract](model-contract.md) between data processors, the [technical](explainer-technical.md), and the [data flows](data-flows.md) details.